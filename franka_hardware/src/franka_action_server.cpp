...
ActionServer::ActionServer(const std::string& prefix, const rclcpp::NodeOptions& options, std::shared_ptr<Robot> robot)
    : rclcpp::Node(prefix+"action_server", options), robot_(std::move(robot)) {
